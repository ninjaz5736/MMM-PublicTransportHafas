...
| `ignoreRelatedStations`           | <p>Ignore departures from related stations or not.</p><p>**Type:** `boolean` **OPTIONAL** <br>**Default Value:** `false`<br>**Possible Values:** `true` and `false`|
...
| `displayLastUpdate`               | <p>If true this will display the last update time at the end of the task list. See screenshot above</p><p>**Type:** `boolean` **OPTIONAL** <br>**Default Value:** `true`</p></p>|
